...
fun box() : String {
    ...
    return adapter.assert(listOf(
        ...
        TraceEvent("GroveHydrated", 4, "before-Patch-External", "createMask: 0xffffffff thisMask: 0xffffffff state: [null]"),
        TraceEvent("GroveHydrated", 4, "after-Patch-External", "createMask: 0xffffffff thisMask: 0xffffffff state: [Hello - 1]"),
        TraceEvent("GroveHydrated", 4, "before-Patch-Internal", "createMask: 0xffffffff thisMask: 0xffffffff state: [Hello - 1]"),
        TraceEvent("GroveHydrated", 4, "after-Patch-Internal", "createMask: 0xffffffff thisMask: 0x00000000 state: [Hello - 1]"),
        TraceEvent("GroveHydrated", 4, "after-Create", ""),
        TraceEvent("GroveHydrated", 5, "before-Create", ""),
        TraceEvent("GroveHydrated", 5, "before-Patch-External", "createMask: 0xffffffff thisMask: 0xffffffff state: [null, null, null]"),
