...
fun Adaptive.loopTest(entries: List<Int>) {
    for (i in entries) {
        T1(i + 10)
    }
}
...
fun box(): String {
    ...
    return AdaptiveTestAdapter.assert(
        listOf(
            ...
            TraceEvent("AdaptiveLoop", 4, "after-Patch-External", "createMask: 0x00000000 thisMask: 0xffffffff state: [ArrayItr,AdaptiveFragmentFactory(3,1)]"),
            TraceEvent("AdaptiveLoop", 4, "before-Patch-Internal", "createMask: 0x00000000 thisMask: 0xffffffff state: [ArrayItr,AdaptiveFragmentFactory(3,1)]"),
            ...
            TraceEvent("AdaptiveLoop", 4, "after-Patch-Internal", "createMask: 0x00000000 thisMask: 0x00000000 state: [ArrayItr,AdaptiveFragmentFactory(3,1)]"),
