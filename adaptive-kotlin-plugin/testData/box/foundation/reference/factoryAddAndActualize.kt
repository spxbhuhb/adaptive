...
fun box() : String {
    ...
    return adapter.assert(listOf(
        ...
        TraceEvent("FoundationActualize", 3, "before-Patch-External", "createMask: 0x00000000 thisMask: 0xffffffff state: [null, null]"),
        TraceEvent("FoundationActualize", 3, "after-Patch-External", "createMask: 0x00000000 thisMask: 0xffffffff state: [null, test:a]"),
        TraceEvent("FoundationActualize", 3, "before-Patch-Internal", "createMask: 0x00000000 thisMask: 0xffffffff state: [null, test:a]"),
        ...
        TraceEvent("AdaptiveSequence", 5, "after-Patch-Internal", "createMask: 0x00000000 thisMask: 0x00000000 state: [null,[1]]"),
        TraceEvent("AdaptiveA", 4, "after-Patch-Internal", "createMask: 0xffffffff thisMask: 0x00000000 state: [null]"),
        TraceEvent("FoundationActualize", 3, "after-Patch-Internal", "createMask: 0x00000000 thisMask: 0x00000000 state: [null, test:a]"),
