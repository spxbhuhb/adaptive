...
fun box(): String {
    ...
    return adapter.assert(
        listOf(
            ...
            TraceEvent("<root>", 2, "before-Add-Producer", "producer: AdaptivePoll(AdaptiveStateVariableBinding(2, 1, 1, 2, 1, null, kotlin.Int, null), 0s)"),
            TraceEvent("<root>", 2, "after-Add-Producer", "producer: AdaptivePoll(AdaptiveStateVariableBinding(2, 1, 1, 2, 1, null, kotlin.Int, null), 0s)"),
