...
fun box(): String {
    ...
    return adapter.assert(
        listOf(
            ...
            TraceEvent("AdaptiveHigherFunInner", 5, "after-Patch-External", "createMask: 0x00000001 thisMask: 0x00000001 state: [240, BoundFragmentFactory(4,1)]"),
            TraceEvent("AdaptiveHigherFunInner", 5, "before-Patch-Internal", "createMask: 0x00000001 thisMask: 0x00000001 state: [240, BoundFragmentFactory(4,1)]"),
            TraceEvent("AdaptiveAnonymous", 6, "before-Patch-External", "createMask: 0x00000001 thisMask: 0x00000001 state: [25]"),
            TraceEvent("AdaptiveAnonymous", 6, "after-Patch-External", "createMask: 0x00000001 thisMask: 0x00000005 state: [241]"),
            TraceEvent("AdaptiveAnonymous", 6, "before-Patch-Internal", "createMask: 0x00000001 thisMask: 0x00000005 state: [241]"),
            ...
            TraceEvent("AdaptiveHigherFun", 8, "after-Patch-External", "createMask: 0x00000003 thisMask: 0x00000001 state: [361, BoundFragmentFactory(3,2)]"),
            TraceEvent("AdaptiveHigherFun", 8, "before-Patch-Internal", "createMask: 0x00000003 thisMask: 0x00000001 state: [361, BoundFragmentFactory(3,2)]"),
            TraceEvent("AdaptiveHigherFunInner", 9, "before-Patch-External", "createMask: 0x00000001 thisMask: 0x00000000 state: [74, BoundFragmentFactory(8,1)]"),
            TraceEvent("AdaptiveHigherFunInner", 9, "after-Patch-External", "createMask: 0x00000001 thisMask: 0x00000001 state: [722, BoundFragmentFactory(8,1)]"),
            TraceEvent("AdaptiveHigherFunInner", 9, "before-Patch-Internal", "createMask: 0x00000001 thisMask: 0x00000001 state: [722, BoundFragmentFactory(8,1)]"),
            TraceEvent("AdaptiveAnonymous", 10, "before-Patch-External", "createMask: 0x00000001 thisMask: 0x00000001 state: [75]"),
            TraceEvent("AdaptiveAnonymous", 10, "after-Patch-External", "createMask: 0x00000001 thisMask: 0x00000005 state: [723]"),
            TraceEvent("AdaptiveAnonymous", 10, "before-Patch-Internal", "createMask: 0x00000001 thisMask: 0x00000005 state: [723]"),
            TraceEvent("AdaptiveAnonymous", 11, "before-Patch-External", "createMask: 0x00000005 thisMask: 0x00000003 state: [112]"),
            TraceEvent("AdaptiveAnonymous", 11, "after-Patch-External", "createMask: 0x00000005 thisMask: 0x00000007 state: [1084]"),
            TraceEvent("AdaptiveAnonymous", 11, "before-Patch-Internal", "createMask: 0x00000005 thisMask: 0x00000007 state: [1084]"),
            ...
            TraceEvent("AdaptiveAnonymous", 11, "after-Patch-Internal", "createMask: 0x00000005 thisMask: 0x00000003 state: [1084]"),
            TraceEvent("AdaptiveAnonymous", 10, "after-Patch-Internal", "createMask: 0x00000001 thisMask: 0x00000001 state: [723]"),
            TraceEvent("AdaptiveHigherFunInner", 9, "after-Patch-Internal", "createMask: 0x00000001 thisMask: 0x00000000 state: [722, BoundFragmentFactory(8,1)]"),
            ...
            TraceEvent("AdaptiveAnonymous", 6, "after-Patch-Internal", "createMask: 0x00000001 thisMask: 0x00000001 state: [241]"),
