...
fun box() : String {
    ...
    return adapter.assert(listOf(
        ...
        TraceEvent("AdaptivePropertyAccessTest", 3, "before-Add-Binding", "binding: AdaptiveStateVariableBinding(3, 0, 0, 4, 0, [i], AdaptivePropertyMetadata(kotlin.Int))"),
        TraceEvent("AdaptivePropertyAccessTest", 3, "after-Add-Binding", "binding: AdaptiveStateVariableBinding(3, 0, 0, 4, 0, [i], AdaptivePropertyMetadata(kotlin.Int))"),
        TraceEvent("AdaptivePropertyAccessor", 4, "after-Patch-External", "createMask: 0x00000000 thisMask: 0xffffffff state: [AdaptiveStateVariableBinding(3, 0, 0, 4, 0, [i], AdaptivePropertyMetadata(kotlin.Int))]"),
        TraceEvent("AdaptivePropertyAccessor", 4, "before-Patch-Internal", "createMask: 0x00000000 thisMask: 0xffffffff state: [AdaptiveStateVariableBinding(3, 0, 0, 4, 0, [i], AdaptivePropertyMetadata(kotlin.Int))]"),
