...
fun box(): String {
    ...
    return adapter.assert(
        listOf(
            ...
            TraceEvent("AdaptiveT1", 8, "after-Patch-External", "createMask: 0xffffffff thisMask: 0xffffffff state: [13]"),
            TraceEvent("AdaptiveT1", 8, "before-Patch-Internal", "createMask: 0xffffffff thisMask: 0xffffffff state: [13]"),
            TraceEvent("AdaptiveT1", 8, "after-Patch-Internal", "createMask: 0xffffffff thisMask: 0x00000000 state: [13]"),
            ...
            TraceEvent("AdaptiveInner", 4, "after-Patch-External", "createMask: 0x00000001 thisMask: 0x00000000 state: [BoundFragmentFactory(3,1)]"),
            TraceEvent("AdaptiveInner", 4, "before-Patch-Internal", "createMask: 0x00000001 thisMask: 0x00000000 state: [BoundFragmentFactory(3,1)]"),
            TraceEvent("AdaptiveAnonymous", 5, "before-Patch-External", "createMask: 0x00000000 thisMask: 0x00000001 state: []"),
            TraceEvent("AdaptiveAnonymous", 5, "after-Patch-External", "createMask: 0x00000000 thisMask: 0x00000001 state: []"),
            TraceEvent("AdaptiveAnonymous", 5, "before-Patch-Internal", "createMask: 0x00000000 thisMask: 0x00000001 state: []"),
            TraceEvent("AdaptiveSequence", 6, "before-Patch-External", "createMask: 0x00000001 thisMask: 0x00000001 state: [2, 3]"),
            TraceEvent("AdaptiveSequence", 6, "after-Patch-External", "createMask: 0x00000001 thisMask: 0x00000001 state: [2, 3]"),
            TraceEvent("AdaptiveSequence", 6, "before-Patch-Internal", "createMask: 0x00000001 thisMask: 0x00000001 state: [2, 3]"),
            TraceEvent("AdaptiveT1", 7, "before-Patch-External", "createMask: 0x00000001 thisMask: 0x00000000 state: [12]"),
            TraceEvent("AdaptiveT1", 7, "after-Patch-External", "createMask: 0x00000001 thisMask: 0x00000001 state: [23]"),
            TraceEvent("AdaptiveT1", 7, "before-Patch-Internal", "createMask: 0x00000001 thisMask: 0x00000001 state: [23]"),
            TraceEvent("AdaptiveT1", 7, "after-Patch-Internal", "createMask: 0x00000001 thisMask: 0x00000000 state: [23]"),
            TraceEvent("AdaptiveT1", 8, "before-Patch-External", "createMask: 0x00000001 thisMask: 0x00000000 state: [13]"),
            TraceEvent("AdaptiveT1", 8, "after-Patch-External", "createMask: 0x00000001 thisMask: 0x00000001 state: [24]"),
            TraceEvent("AdaptiveT1", 8, "before-Patch-Internal", "createMask: 0x00000001 thisMask: 0x00000001 state: [24]"),
            TraceEvent("AdaptiveT1", 8, "after-Patch-Internal", "createMask: 0x00000001 thisMask: 0x00000000 state: [24]"),
            TraceEvent("AdaptiveSequence", 6, "after-Patch-Internal", "createMask: 0x00000001 thisMask: 0x00000001 state: [2, 3]"),
            TraceEvent("AdaptiveAnonymous", 5, "after-Patch-Internal", "createMask: 0x00000000 thisMask: 0x00000001 state: []"),
