...
fun box(): String {
    ...
    return adapter.assert(
        listOf(
            ...
            TraceEvent("AdaptiveLoop", 4, "after-Patch-External", "createMask: 0x00000000 thisMask: 0xffffffff state: [IntProgressionIterator,BoundFragmentFactory(3,1)]"),
            TraceEvent("AdaptiveLoop", 4, "before-Patch-Internal", "createMask: 0x00000000 thisMask: 0xffffffff state: [IntProgressionIterator,BoundFragmentFactory(3,1)]"),
            ...
            TraceEvent("AdaptiveLoop", 4, "after-Patch-Internal", "createMask: 0x00000000 thisMask: 0x00000000 state: [IntProgressionIterator,BoundFragmentFactory(3,1)]"),
