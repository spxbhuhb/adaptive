...
fun box(): String {
    ...
    return adapter.assert(
        listOf(
            ...
            TraceEvent("AdaptiveLoopTest", 3, "after-Patch-External", "createMask: 0x00000000 thisMask: 0xffffffff state: [null, 3]"),
            TraceEvent("AdaptiveLoopTest", 3, "before-Patch-Internal", "createMask: 0x00000000 thisMask: 0xffffffff state: [null, 3]"),
            TraceEvent("AdaptiveLoopTest", 3, "after-Patch-Internal", "createMask: 0x00000000 thisMask: 0x00000000 state: [null, 3]"),
            ...
            TraceEvent("AdaptiveLoop", 4, "after-Patch-External", "createMask: 0x00000000 thisMask: 0xffffffff state: [null,IntProgressionIterator,BoundFragmentFactory(3,1)]"),
            TraceEvent("AdaptiveLoop", 4, "before-Patch-Internal", "createMask: 0x00000000 thisMask: 0xffffffff state: [null,IntProgressionIterator,BoundFragmentFactory(3,1)]"),
            ...
            TraceEvent("AdaptiveLoop", 4, "after-Patch-Internal", "createMask: 0x00000000 thisMask: 0x00000000 state: [null,IntProgressionIterator,BoundFragmentFactory(3,1)]"),
