...
fun box(): String {
    ...
    return adapter.assert(
        listOf(
            ...
            TraceEvent("AdaptiveCopyStoreTest", 3, "before-Add-Producer", "producer: CopyStore(AdaptiveStateVariableBinding(3, 1, 1, 3, 1, null, fun.adaptive.kotlin.base.success.T, fun.adaptive.kotlin.base.success.T))"),
            TraceEvent("AdaptiveCopyStoreTest", 3, "before-Remove-Producer", "producer: CopyStore(AdaptiveStateVariableBinding(3, 1, 1, 3, 1, null, fun.adaptive.kotlin.base.success.T, fun.adaptive.kotlin.base.success.T))"),
            TraceEvent("AdaptiveCopyStoreTest", 3, "after-Remove-Producer", "producer: CopyStore(AdaptiveStateVariableBinding(3, 1, 1, 3, 1, null, fun.adaptive.kotlin.base.success.T, fun.adaptive.kotlin.base.success.T))"),
            TraceEvent("AdaptiveCopyStoreTest", 3, "after-Add-Producer", "producer: CopyStore(AdaptiveStateVariableBinding(3, 1, 1, 3, 1, null, fun.adaptive.kotlin.base.success.T, fun.adaptive.kotlin.base.success.T))"),
            ...
            TraceEvent("AdaptiveT1", 4, "after-Patch-Internal", "createMask: 0x00000003 thisMask: 0x00000000 state: [25]"),
            TraceEvent("AdaptiveCopyStoreTest", 3, "after-Patch-Internal", "createMask: 0x00000001 thisMask: 0x00000000 state: [23, T(ti=25)]")
            //@formatter:on
        )
    )
}