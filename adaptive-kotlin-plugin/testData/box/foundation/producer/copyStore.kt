...
fun box(): String {
    ...
    return adapter.assert(
        listOf(
            ...
            TraceEvent("AdaptiveCopyStoreTest", 3, "before-Add-Producer", "producer: CopyStore(AdaptiveStateVariableBinding(3, 2, 2, 3, 2, null, fun.adaptive.kotlin.base.success.T, fun.adaptive.kotlin.base.success.T))"),
            TraceEvent("AdaptiveCopyStoreTest", 3, "before-Remove-Producer", "producer: CopyStore(AdaptiveStateVariableBinding(3, 2, 2, 3, 2, null, fun.adaptive.kotlin.base.success.T, fun.adaptive.kotlin.base.success.T))"),
            TraceEvent("AdaptiveCopyStoreTest", 3, "after-Remove-Producer", "producer: CopyStore(AdaptiveStateVariableBinding(3, 2, 2, 3, 2, null, fun.adaptive.kotlin.base.success.T, fun.adaptive.kotlin.base.success.T))"),
            TraceEvent("AdaptiveCopyStoreTest", 3, "after-Add-Producer", "producer: CopyStore(AdaptiveStateVariableBinding(3, 2, 2, 3, 2, null, fun.adaptive.kotlin.base.success.T, fun.adaptive.kotlin.base.success.T))"),
            TraceEvent("AdaptiveT1", 4, "before-Patch-External", "createMask: 0x00000006 thisMask: 0x00000000 state: [null, 14]"),
            TraceEvent("AdaptiveT1", 4, "after-Patch-External", "createMask: 0x00000006 thisMask: 0x00000002 state: [null, 25]"),
            TraceEvent("AdaptiveT1", 4, "before-Patch-Internal", "createMask: 0x00000006 thisMask: 0x00000002 state: [null, 25]"),
            TraceEvent("AdaptiveT1", 4, "after-Patch-Internal", "createMask: 0x00000006 thisMask: 0x00000000 state: [null, 25]"),
            TraceEvent("AdaptiveCopyStoreTest", 3, "after-Patch-Internal", "createMask: 0x00000002 thisMask: 0x00000000 state: [null, 23, T(ti=25)]")
            //@formatter:on
        )
    )
}