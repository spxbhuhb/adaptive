...
fun box() : String {
    ...
    return adapter.assert(listOf(
        ...
        TraceEvent("AdaptiveAccessTest", 3, "before-Add-Binding", "binding: AdaptiveStateVariableBinding(3, 0, 0, 4, 1, null, I, null)"),
        TraceEvent("AdaptiveAccessTest", 3, "after-Add-Binding", "binding: AdaptiveStateVariableBinding(3, 0, 0, 4, 1, null, I, null)"),
        TraceEvent("AdaptiveAccessor", 4, "after-Patch-External", "createMask: 0x00000000 thisMask: 0xffffffff state: [[Name(name=a)], AdaptiveStateVariableBinding(3, 0, 0, 4, 1, null, I, null)]"),
        TraceEvent("AdaptiveAccessor", 4, "before-Patch-Internal", "createMask: 0x00000000 thisMask: 0xffffffff state: [[Name(name=a)], AdaptiveStateVariableBinding(3, 0, 0, 4, 1, null, I, null)]"),
        TraceEvent("AdaptiveAccessor", 4, "after-Patch-Internal", "createMask: 0x00000000 thisMask: 0x00000000 state: [[Name(name=a)], AdaptiveStateVariableBinding(3, 0, 0, 4, 1, null, I, null)]"),
