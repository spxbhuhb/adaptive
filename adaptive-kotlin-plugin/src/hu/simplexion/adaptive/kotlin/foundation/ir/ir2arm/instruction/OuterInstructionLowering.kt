...
class OuterInstructionLowering(
    ...
    fun flattenInstructionCalls(expression: IrExpression): Pair<IrCall, List<IrExpression>> {
        ...
        //    CALL 'public final fun rangeTo (instruction: hu.simplexion.adaptive.foundation.instruction.AdaptiveInstruction): hu.simplexion.adaptive.foundation.AdaptiveFragment [operator] declared in hu.simplexion.adaptive.foundation' type=hu.simplexion.adaptive.foundation.AdaptiveFragment origin=RANGE
        //      $receiver: CALL 'public final fun testFragment (vararg instructions: hu.simplexion.adaptive.foundation.instruction.AdaptiveInstruction, block: kotlin.Function0<kotlin.Unit>): hu.simplexion.adaptive.foundation.AdaptiveFragment declared in stuff' type=hu.simplexion.adaptive.foundation.AdaptiveFragment origin=null
        ...
        //      instruction: CALL 'public final fun name (name: kotlin.String): hu.simplexion.adaptive.foundation.instruction.Name declared in hu.simplexion.adaptive.foundation.instruction' type=hu.simplexion.adaptive.foundation.instruction.Name origin=null
