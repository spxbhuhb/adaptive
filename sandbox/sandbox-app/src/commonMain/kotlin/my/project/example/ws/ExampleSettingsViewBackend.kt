...
import `fun`.adaptive.ui.mpw.logic.SingularPaneViewBackend

class ExampleSettingsViewBackend(
    module: ExampleWsModule<*>
) : SingularPaneViewBackend<ExampleSettingsViewBackend>(module.workspace, module.EXAMPLE_SETTINGS_ITEM) {
