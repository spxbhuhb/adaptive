...
class FilePersistenceTest {
    ...
    fun `test save and load value`() {
        ...
        val value = AvString(UUID("48852c46-8e5a-40a1-a9c8-e757c6f58200"), now(), AvStatus.OK, "TestData")
    ...
    fun `test load multiple values`() {
        ...
        val value1 = AvString(UUID("48852c46-8e5a-40a1-a9c8-e757c6f58200"), now(), AvStatus.OK, "Data1")
        val value2 = AvString(UUID("123e4567-e89b-12d3-a456-426614174000"), now(), AvStatus.OK, "Data2")
