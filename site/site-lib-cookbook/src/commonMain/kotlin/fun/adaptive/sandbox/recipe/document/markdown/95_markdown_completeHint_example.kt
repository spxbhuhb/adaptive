...
/**
 * # All markdown features - hint
 */
@Adaptive
fun markdownCompleteHintExample(): AdaptiveFragment {

    markdownHint(completeContent)
...
private val completeContent = """
    ...
    * List item 3
    ...
    ![An image](https://raw.githubusercontent.com/spxbhuhb/adaptive-site-resources/110801e15484cbe47db9396fc78827ab79408a82/images/preview-status-50.jpg)
""".trimIndent()