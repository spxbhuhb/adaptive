...
private fun recipeGrid(title : String, align: AlignItems) {
    column {
        ...
        grid {
            ...
            box { size(80.dp, 80.dp) .. backgrounds.failSurface }
            box { size(80.dp, 80.dp) .. backgrounds.successSurface }
            box { size(80.dp, 80.dp) .. backgrounds.warningSurface }
            box { size(80.dp, 80.dp) .. backgrounds.infoSurface }
        }
    }
}