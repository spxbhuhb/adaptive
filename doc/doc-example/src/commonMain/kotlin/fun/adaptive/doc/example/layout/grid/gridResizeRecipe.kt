...
fun gridResizeRecipe() {
    ...
    box {
        ...
        box {
            maxWidth .. backgrounds.warningSurface
...
private fun line(number: Int) {
    row {
        maxSize .. backgrounds.failSurface .. alignItems.center
        text("$number.1") .. textColors.white
    }
    row {
        maxWidth .. backgrounds.successSurface .. alignItems.center
        text("$number.2") .. maxSize
    }
    row {
        maxHeight .. backgrounds.surfaceVariant .. alignItems.center
