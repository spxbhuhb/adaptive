...
fun box(): String {
    ...
    return adapter.assert(listOf(
        ...
        TraceEvent("AdaptiveSequence", 3, "after-Patch-External", "createMask: 0x00000000 thisMask: 0xffffffff state: [null,[1, 3]]"),
        TraceEvent("AdaptiveSequence", 3, "before-Patch-Internal", "createMask: 0x00000000 thisMask: 0xffffffff state: [null,[1, 3]]"),
        ...
        TraceEvent("AdaptiveText", 4, "after-Patch-External", "createMask: 0xffffffff thisMask: 0xffffffff state: [[Detach], Label]"),
        TraceEvent("AdaptiveText", 4, "before-Patch-Internal", "createMask: 0xffffffff thisMask: 0xffffffff state: [[Detach], Label]"),
        TraceEvent("AdaptiveText", 4, "after-Patch-Internal", "createMask: 0xffffffff thisMask: 0x00000000 state: [[Detach], Label]"),
        ...
        TraceEvent("AdaptiveSequence", 5, "after-Patch-External", "createMask: 0x00000000 thisMask: 0xffffffff state: [null,[]]"),
        TraceEvent("AdaptiveSequence", 5, "before-Patch-Internal", "createMask: 0x00000000 thisMask: 0xffffffff state: [null,[]]"),
        TraceEvent("AdaptiveSequence", 5, "after-Patch-Internal", "createMask: 0x00000000 thisMask: 0x00000000 state: [null,[]]"),
        ...
        TraceEvent("AdaptiveText", 6, "after-Patch-External", "createMask: 0xffffffff thisMask: 0xffffffff state: [[Detach], Label]"),
        TraceEvent("AdaptiveText", 6, "before-Patch-Internal", "createMask: 0xffffffff thisMask: 0xffffffff state: [[Detach], Label]"),
        TraceEvent("AdaptiveText", 6, "after-Patch-Internal", "createMask: 0xffffffff thisMask: 0x00000000 state: [[Detach], Label]"),
        TraceEvent("AdaptiveSequence", 7, "before-Create", ""),
        TraceEvent("AdaptiveSequence", 7, "before-Patch-External", "createMask: 0x00000000 thisMask: 0xffffffff state: [null,null]"),
        TraceEvent("AdaptiveSequence", 7, "after-Patch-External", "createMask: 0x00000000 thisMask: 0xffffffff state: [null,[]]"),
        TraceEvent("AdaptiveSequence", 7, "before-Patch-Internal", "createMask: 0x00000000 thisMask: 0xffffffff state: [null,[]]"),
        TraceEvent("AdaptiveSequence", 7, "after-Patch-Internal", "createMask: 0x00000000 thisMask: 0x00000000 state: [null,[]]"),
        TraceEvent("AdaptiveSequence", 7, "after-Create", ""),
        TraceEvent("AdaptiveText", 6, "after-Create", ""),
        TraceEvent("AdaptiveSequence", 3, "after-Patch-Internal", "createMask: 0x00000000 thisMask: 0x00000000 state: [null,[1, 3]]"),
        ...
        TraceEvent("AdaptiveT1", 9, "before-Patch-External", "createMask: 0x00000000 thisMask: 0xffffffff state: [null, null]"),
        TraceEvent("AdaptiveT1", 9, "after-Patch-External", "createMask: 0x00000000 thisMask: 0xffffffff state: [null, 23]"),
        TraceEvent("AdaptiveT1", 9, "before-Patch-Internal", "createMask: 0x00000000 thisMask: 0xffffffff state: [null, 23]"),
        TraceEvent("AdaptiveT1", 9, "after-Patch-Internal", "createMask: 0x00000000 thisMask: 0x00000000 state: [null, 23]"),
