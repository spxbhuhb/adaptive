...
fun box() : String {
    ...
    return adapter.assert(listOf(
        ...
        TraceEvent("AdaptiveWhenNoSubjectElse", 3, "before-Patch-External", "createMask: 0x00000000 thisMask: 0xffffffff state: [null, null]"),
        TraceEvent("AdaptiveWhenNoSubjectElse", 3, "after-Patch-External", "createMask: 0x00000000 thisMask: 0xffffffff state: [null, a]"),
        TraceEvent("AdaptiveWhenNoSubjectElse", 3, "before-Patch-Internal", "createMask: 0x00000000 thisMask: 0xffffffff state: [null, a]"),
        TraceEvent("AdaptiveWhenNoSubjectElse", 3, "after-Patch-Internal", "createMask: 0x00000000 thisMask: 0x00000000 state: [null, a]"),
        ...
        TraceEvent("AdaptiveWhenNoSubjectElse", 3, "before-Mount", ""),
        ...
        TraceEvent("AdaptiveWhenNoSubjectElse", 3, "after-Mount", ""),
        TraceEvent("<root>", 2, "after-Mount", ""),
        TraceEvent("<root>", 2, "before-Patch-Internal", "createMask: 0x00000002 thisMask: 0x00000002 state: [null, b]"),
        TraceEvent("AdaptiveWhenNoSubjectElse", 3, "before-Patch-External", "createMask: 0x00000002 thisMask: 0x00000000 state: [null, a]"),
        TraceEvent("AdaptiveWhenNoSubjectElse", 3, "after-Patch-External", "createMask: 0x00000002 thisMask: 0x00000002 state: [null, b]"),
        TraceEvent("AdaptiveWhenNoSubjectElse", 3, "before-Patch-Internal", "createMask: 0x00000002 thisMask: 0x00000002 state: [null, b]"),
        ...
        TraceEvent("AdaptiveWhenNoSubjectElse", 3, "after-Patch-Internal", "createMask: 0x00000002 thisMask: 0x00000000 state: [null, b]"),
        ...
        TraceEvent("AdaptiveWhenNoSubjectElse", 3, "before-Patch-External", "createMask: 0x00000002 thisMask: 0x00000000 state: [null, b]"),
        TraceEvent("AdaptiveWhenNoSubjectElse", 3, "after-Patch-External", "createMask: 0x00000002 thisMask: 0x00000002 state: [null, c]"),
        TraceEvent("AdaptiveWhenNoSubjectElse", 3, "before-Patch-Internal", "createMask: 0x00000002 thisMask: 0x00000002 state: [null, c]"),
        ...
        TraceEvent("AdaptiveWhenNoSubjectElse", 3, "after-Patch-Internal", "createMask: 0x00000002 thisMask: 0x00000000 state: [null, c]"),
