...
private val addSite = MenuItem(Graphics.responsive_layout, Strings.addSite, AioSpaceEditOperation.AddSite)
private val addBuilding = MenuItem(Graphics.apartment, Strings.addBuilding, AioSpaceEditOperation.AddBuilding)
private val addFloor = MenuItem(Graphics.stacks, Strings.addFloor, AioSpaceEditOperation.AddFloor)
private val addRoom = MenuItem(Graphics.meeting_room, Strings.addRoom, AioSpaceEditOperation.AddRoom)
private val addArea = MenuItem(Graphics.crop_5_4, Strings.addArea, AioSpaceEditOperation.AddArea)
...
private fun menu(viewModel: SpaceTreeModel, treeItem: TreeItem<AvValueId>): List<MenuItemBase<AioSpaceEditOperation>> {
    ...
    out += MenuItem(null, Strings.inactivate, AioSpaceEditOperation.Inactivate)
