...
fun main() {
    WsBrowserApplication(
        ...
        // modules
        LibUiModule(),
        GroveRuntimeModule<Workspace, UiClientApplication<Workspace, UiClientApplicationData>>(),
        ChartWsModule(),
        DocWsModule(),
        IotWsModule(),
        ZigbeeModule<Workspace, UiClientApplication<Workspace, UiClientApplicationData>>(),
        BasicAppWsModule(),
