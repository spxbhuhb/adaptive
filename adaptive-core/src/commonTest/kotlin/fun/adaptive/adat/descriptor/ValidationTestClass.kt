...
import `fun`.adaptive.adat.descriptor.constraint.maximum
import `fun`.adaptive.adat.descriptor.constraint.minimum
import `fun`.adaptive.adat.descriptor.info.default
...
//    }
    ...
    companion object : AdatCompanion<ValidationTestClass> {
        ...
        override val wireFormatName: String
            get() = "fun.adaptive.adat.descriptor.ValidationTestClass"

        override val adatMetadata = decodeMetadata("1/`fun`.adaptive.adat.TestClass/someInt/0/I/someBoolean/1/Z/someIntListSet/2/Lkotlin.collections.Set<Lkotlin.collections.List<I>;>;")
