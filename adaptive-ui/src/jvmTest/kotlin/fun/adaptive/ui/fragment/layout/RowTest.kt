...
class RowTest {
    ...
    fun gap() {
        ...
        cff(`fun`.adaptive.ui.api.gap { 5.dp }) {
            assertFinal(C1, 0, 0, 400, 400)
            assertFinal(F1, 0, 0, 120, 20)
    ...
    fun `alignItems topStart gap 5`() {
        ...
        cff(alignItems.topStart, `fun`.adaptive.ui.api.gap { 5.dp }) {
            assertFinal(C1, 0, 0, 400, 400)
            assertFinal(F1, 0, 0, 120, 20)
            assertFinal(F2, 0, 125, 160, 20)
        }
    ...
    fun `alignItems topCenter gap 6`() {
        ...
        cff(alignItems.topCenter, `fun`.adaptive.ui.api.gap { 6.dp }) {
    ...
    fun `alignItems topEnd gap 6`() {
        ...
        cff(alignItems.topEnd, `fun`.adaptive.ui.api.gap { 6.dp }) {
            assertFinal(C1, 0, 0, 400, 400)
    ...
    fun `alignItems startCenter gap 6`() {
        ...
        cff(alignItems.startCenter, `fun`.adaptive.ui.api.gap { 6.dp }) {
            assertFinal(C1, 0, 0, 400, 400)
    ...
    fun `alignItems startBottom gap 6`() {
        ...
        cff(alignItems.startBottom, `fun`.adaptive.ui.api.gap { 6.dp }) {
            assertFinal(C1, 0, 0, 400, 400)
    ...
    fun `alignItems bottomCenter gap 6`() {
        ...
        cff(alignItems.bottomCenter, `fun`.adaptive.ui.api.gap { 6.dp }) {
    ...
    fun `alignItems bottomEnd gap 6`() {
        ...
        cff(alignItems.bottomEnd, `fun`.adaptive.ui.api.gap { 6.dp }) {
            assertFinal(C1, 0, 0, 400, 400)
