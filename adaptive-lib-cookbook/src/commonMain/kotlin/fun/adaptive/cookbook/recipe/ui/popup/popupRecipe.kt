package `fun`.adaptive.cookbook.recipe.ui.popup/*
 * Copyright © 2020-2024, Simplexion, Hungary and contributors. Use of this source code is governed by the Apache 2.0 license.
 */

import `fun`.adaptive.cookbook.hoverForPopup
import `fun`.adaptive.cookbook.leftClickForPopup
import `fun`.adaptive.cookbook.popupContent
import `fun`.adaptive.cookbook.rightClickForPopup
